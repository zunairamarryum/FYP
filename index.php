...
<body class="home">
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo-small.png" alt="" width="15%"> </a>
    ...
    <section class="hero bg-image" data-image-src="images/home-pic.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Get It Delivered or Grab It To-Go</h1>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><strong><span style="color:white;">1. </span>Select Your Cravings</strong></h4>
                    </div>
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><strong><span style="color:white;">2. </span>Order Food</strong></h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><strong><span style="color:white;">3. </span>Opt for Home Delivery or Pick-Up</strong></h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Best Bites of the year</h2>
                <p class="lead">Easiest way to order Featured Foods Online</p>
            </div>
            <div class="row">
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">Rs. '.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn pull-right" style="border:2px dotted brown">Order Now</a> </div>
                                                </div>
