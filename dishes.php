...
<body>
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo-small.png" alt="" width="25%"> </a>
    ...
    <div class="page-wrapper">
        <div class="top-links">
            <div class="container">
                <ul class="row links" style="padding:10px;">
        ...
        <?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
        <section class="inner-page-hero bg-image" data-image-src="images/dishes.jpg">
            <div class="profile">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="food-item">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info">
                                        ...
                                        <input type="submit" class="btn theme-btn" style="margin-left:40px;margin-top:2px;" value="Add To Cart" />
                                    </div>
                                    </form>
                                </div>
